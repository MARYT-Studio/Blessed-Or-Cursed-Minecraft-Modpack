...
// Killcount Tokens
val firstKillcountToken as IItemStack = <contenttweaker:first_killcount_token>;
...
val secondKillcountToken as IItemStack = <contenttweaker:second_killcount_token>;
...
val thirdKillcountToken as IItemStack = <contenttweaker:third_killcount_token>;
...
val fourthKillcountToken as IItemStack = <contenttweaker:fourth_killcount_token>;
...
val secondProudsoulBottle as IItemStack = <contenttweaker:second_proudsoul_bottle>;
...
val thirdProudsoulBottle as IItemStack = <contenttweaker:third_proudsoul_bottle>;
...
// Tier 1 SlashBlades
val T1_SlashBlades = <slashblade:slashbladewhite>;

// Tier 2 SlashBlades
val mingdao_Xiewan = <lastsmith:slashblade.named>.withTag({TextureName: "named/sekiro/kusabimaru", ModelName: "named/sekiro/kusabimaru", CurrentItemName: "slashblade.named.kusabimaru", baseAttackModifier: 5.0 as float});
val ziduandao_Yongzhen = <lastsmith:slashblade.named>.withTag({TextureName: "named/namedblade/texture_nagasada", ModelName: "named/namedblade/model_stright", CurrentItemName: "slashblade.named.nagasada", IsFakeBlade: 1 as byte, baseAttackModifier: 6.0 as float});
val gangjian_Dongtianguan = <lastsmith:slashblade.named>.withTag({TextureName: "named/muramasa/doutanuki", ModelName: "named/muramasa/muramasa", CurrentItemName: "slashblade.named.doutanuki", baseAttackModifier: 6.0 as float});
...
val qianhe_Cunzheng = <lastsmith:slashblade.named>.withTag({TextureName: "named/muramasa/muramasa", ModelName: "named/muramasa/muramasa", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.muramasa", baseAttackModifier: 6.0 as float});
val shengxingdao_Lvnaiwu = <lastsmith:slashblade.named>.withTag({ModelName: "named/blademaster/blademaster", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.blademaster.greenmist", TextureName: "named/blademaster/greenmist", baseAttackModifier: 7.0 as float});
val shiyuedao_Yanshuibozhan = <lastsmith:slashblade.named>.withTag({ModelName: "named/blademaster/blademaster", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.blademaster.aquablaze", AttackAmplifier: -5.0 as float, TextureName: "named/blademaster/aquablaze", baseAttackModifier: 7.0 as float});
val yueguangying_Chuixueyishan = <lastsmith:slashblade.named>.withTag({ModelName: "named/blademaster/blademaster", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.blademaster.moonlightcherry", TextureName: "named/blademaster/greenmist", baseAttackModifier: 7.0 as float});
val xingyuedao_Kongzhijingjie = <lastsmith:slashblade.named>.withTag({TextureName: "named/tboen/texture", ModelName: "named/tboen/model", CurrentItemName: "slashblade.named.tboen", baseAttackModifier: 7.0 as float});
val jieyuedao_Yinyuan = <lastsmith:slashblade.named>.withTag({TextureName: "named/yukari/texture", ModelName: "named/yukari/model", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.yukari", baseAttackModifier: 7.0 as float});
val yingguang = <lastsmith:slashblade.named>.withTag({TextureName: "named/fluorescentbar/fluorescentbar", ModelName: "named/fluorescentbar/fluorescentbar", CurrentItemName: "slashblade.named.fluorescentbar", baseAttackModifier: 2.0 as float});
val fenglaijian = <lastsmith:slashblade.named>.withTag({TextureName: "named/wanderer/wanderer", ModelName: "named/wanderer/wanderer", CurrentItemName: "slashblade.named.wanderer", baseAttackModifier: 7.0 as float});
val fenglaizhixieren =  <lastsmith:slashblade_rf>.withTag({ModelName: "named/wanderer/wanderer", ModelOnName: "named/wanderer/wanderer", CurrentItemName: "slashblade.named.wanderer.rfblade", AttackAmplifier: -5.0 as float, TextureName: "named/wanderer/wanderer", TextureOnName: "named/wanderer/wanderer", baseAttackModifier: 7.0 as float});
val shanying_Shizou = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_shiwasu", ModelName: "named/yamazakura/shimotsuki", CurrentItemName: "slashblade.named.yamazakura.shiwasu", IsFakeBlade: 1 as byte, baseAttackModifier: 7.0 as float});
val shanying_Shuangyue = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_shimotsuki", ModelName: "named/yamazakura/shimotsuki", CurrentItemName: "slashblade.named.yamazakura.shimotsuki", IsFakeBlade: 1 as byte, baseAttackModifier: 7.0 as float});
val shanyingchangyue_Ju = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_nagatsuki_kiku", ModelName: "named/yamazakura/fumizuki", CurrentItemName: "slashblade.named.yamazakura.kiku", IsFakeBlade: 1 as byte, baseAttackModifier: 6.0 as float});
val shanying_Yeyue = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_hazuki", ModelName: "named/yamazakura/fumizuki_fake", CurrentItemName: "slashblade.named.yamazakura.hazuki", IsFakeBlade: 1 as byte, baseAttackModifier: 6.0 as float});
val shanying_Gaoyue = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_satsuki", ModelName: "named/yamazakura/satsuki", CurrentItemName: "slashblade.named.yamazakura.satsuki", IsFakeBlade: 1 as byte, baseAttackModifier: 6.0 as float});
val shanying_Maoyue =  <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_uzuki", ModelName: "named/yamazakura/uzuki", CurrentItemName: "slashblade.named.yamazakura.uzuki", IsFakeBlade: 1 as byte, baseAttackModifier: 6.0 as float});
val shanyingmisheng_Ying = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_yayoi_sakura", ModelName: "named/yamazakura/model_fake", CurrentItemName: "slashblade.named.yamazakura.sakura", IsFakeBlade: 1 as byte, baseAttackModifier: 5.0 as float});
val shanyingruyue_Mei = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_kisaragi_ume", ModelName: "named/yamazakura/model_fake", CurrentItemName: "slashblade.named.yamazakura.ume", IsFakeBlade: 1 as byte, baseAttackModifier: 5.0 as float});
val shanyingmuyue_Song = <lastsmith:slashblade.named>.withTag({TextureName: "named/yamazakura/yamazakura_mutsuki_kadomatsu", ModelName: "named/yamazakura/model_fake", CurrentItemName: "slashblade.named.yamazakura.kadomatsu", IsFakeBlade: 1 as byte, baseAttackModifier: 5.0 as float});
val huyuedao_Baihu = <lastsmith:slashblade.named>.withTag({ModelName: "named/sange/sange", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.fox.white", TextureName: "named/sange/white", TrueItemName: "slashblade.named.fox.white", isBroken: 0 as byte, baseAttackModifier: 4.0 as float});
val huyuedao_Heihu = <lastsmith:slashblade.named>.withTag({ModelName: "named/sange/sange", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.fox.black", TextureName: "named/sange/black", TrueItemName: "slashblade.named.fox.black", isBroken: 0 as byte, baseAttackModifier: 4.0 as float});
val dongyingdao_Xuehuacangyue = <lastsmith:slashblade.named>.withTag({TextureName: "named/frostwolf/frostwolfa", ModelName: "named/frostwolf/frostwolfa", CurrentItemName: "slashblade.named.frostwolfa", baseAttackModifier: 7.0 as float});
val mingshoudao_Yangyabinglang = <lastsmith:slashblade.named>.withTag({TextureName: "named/frostwolf/frostwolfb", ModelName: "named/frostwolf/frostwolfb", CurrentItemName: "slashblade.named.frostwolfb", baseAttackModifier: 7.0 as float});
val dao = <lastsmith:slashblade.named>.withTag({TextureName: "wa/waA", ModelName: "wa/model", CurrentItemName: "slashblade.named.wa.katana", baseAttackModifier: 3.0 as float});
val taidao = <lastsmith:slashblade.named>.withTag({TextureName: "wa/waB", ModelName: "wa/model", CurrentItemName: "slashblade.named.wa.tachi", baseAttackModifier: 3.0 as float});
...
val doudao_Gudu = <lastsmith:slashblade.named>.withTag({TextureName: "named/namedblade/texture_super", ModelName: "named/namedblade/model", CurrentItemName: "slashblade.named.kogawa_super", baseAttackModifier: 7.0 as float});
val mojian_Yanmodao = <lastsmith:slashblade.named>.withTag({ModelName: "named/yamato", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.yamato", TextureName: "named/yamato", IsBewitchedActived: 1 as byte, baseAttackModifier: 7.0 as float});
...
val lanyecha = <lastsmith:slashblade.named>.withTag({ModelName: "named/yasha/yasha", isDefaultBewitched: 1 as byte, IsNoStandDrop: 1 as byte, CurrentItemName: "slashblade.named.yasha", TextureName: "named/yasha/yasha", baseAttackModifier: 6.0 as float});
val hongyecha = <lastsmith:slashblade.named>.withTag({TextureName: "named/yasha/yasha", ModelName: "named/yasha/yashaTrue", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.yashatrue", baseAttackModifier: 6.0 as float});
val kushidadao = <lastsmith:slashblade.named>.withTag({onClick: 0 as byte, ModelName: "named/dios/dios", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.koseki",TextureName: "named/dios/koseki", isBroken: 0 as byte, baseAttackModifier: 6.0 as float});
val lanemen = <lastsmith:slashblade.named>.withTag({ModelName: "named/agito", CurrentItemName: "slashblade.named.agito", TextureName: "named/agito_false", isBroken: 0 as byte, baseAttackModifier: 6.0 as float});
val dashe_Emen = <lastsmith:slashblade.named>.withTag({TextureName: "named/orotiagito", ModelName: "named/agito", CurrentItemName: "slashblade.named.orotiagito", IsBewitchedActived: 1 as byte, baseAttackModifier: 7.0 as float});
//All T3 Blades List
val T3_SlashBlades =
    lanyecha|
    hongyecha|
...
// Tier 4 SlashBlades
val tianyun_Wunian = <lastsmith:slashblade.named>.withTag({ModelName: "named/smith/model", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.smith.final", TextureName: "named/smith/texture_final", IsBewitchedActived: 1 as byte, isBroken: 0 as byte, baseAttackModifier: 31.0 as float});
// All T4 Blades List
...
// val T2_allowed_SlashBlades as IIngredient[] = [T2_SlashBlades, T3_SlashBlades, T4_SlashBlades];
// val T3_allowed_SlashBlades as IIngredient[] = [T3_SlashBlades, T4_SlashBlades];
val Blades as IIngredient[][] = [T1_allowed_SlashBlades, T2_allowed_SlashBlades, T3_allowed_SlashBlades];

// Materials Array
val killCountTokens as IItemStack[] = [firstKillcountToken, secondKillcountToken, thirdKillcountToken, fourthKillcountToken];
val proudSoulBottles as IItemStack[] = [firstProudsoulBottle, secondProudsoulBottle, thirdProudsoulBottle];

for tier in 0 to 4 {
    
    // Killcount Tokens
    mods.jei.JEI.addDescription(killCountTokens[tier], descText[tier]);
    
    // Proudsoul Bottles
    if (tier >= 1) {
        mods.jei.JEI.addDescription(proudSoulBottles[tier - 1], descText[tier]); 
    }

    // Blades
    if (tier < 3)
    for blade_tier in Blades[tier] {
        for blade in blade_tier.items {
            mods.jei.JEI.addDescription(blade, descText[tier]); 
        }
    } else {
        mods.jei.JEI.addDescription(T4_SlashBlades, descText[tier]); 
        mods.jei.JEI.addDescription(fourthKillcountToken, descText[tier]); 
        mods.jei.JEI.addDescription(thirdProudsoulBottle, descText[tier]); 
    }
