...
val anya = <lastsmith:slashblade.named>.withTag({ModelName: "named/darkraven/darkraven", CurrentItemName: "slashblade.named.darkraven", TextureName: "named/darkraven/darkraven"});
