...
val anya = <lastsmith:.slashblade.named>.withTag({ModelName: "named/darkraven/darkraven", CurrentItemName: "flammpfeil.slashblade.named.darkraven", TextureName: "named/darkraven/darkraven"});
