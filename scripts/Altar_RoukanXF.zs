...
val louguan_xuanfeng = <lastsmith:slashblade_wind>.withTag({infench: [{lvl: 3 as short, id: 5 as short}], ench: [{lvl: 4 as short, id: 34 as short}, {lvl: 4 as short, id: 16 as short}], ModelName: "named/roukan/model", isDefaultBewitched: 1 as byte, CurrentItemName: "flammpfeil.slashblade.named.roukan_xf", AttackAmplifier: -14.0 as float, TextureName: "named/roukan/texture_xf", CustomMaxDamage: 40, IsBewitchedActived: 1 as byte, baseAttackModifier: 16.0 as float, "SB.SEffect": {extreme_sharpness: 10}, StandbyRenderType: 2});
