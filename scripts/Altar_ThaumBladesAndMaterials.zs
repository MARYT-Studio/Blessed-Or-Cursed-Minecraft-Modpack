...
val longtaidao = <lastsmith:slashblade_wind>.withTag({ModelName: "zephyr/model", isDefaultBewitched: 1 as byte, CurrentItemName: "slashblade.named.windeater", TextureName: "zephyr/tex"});
