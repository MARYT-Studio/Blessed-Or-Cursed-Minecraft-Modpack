...
val longtaidao = <flammpfeil.slashblade:proudsoul:4>.withTag({infench: [{lvl: 3 as short, id: 5 as short}], ModelName: "zephyr/model", isDefaultBewitched: 1 as byte, CurrentItemName: "flammpfeil.slashblade.named.windeater", TextureName: "zephyr/tex"});
