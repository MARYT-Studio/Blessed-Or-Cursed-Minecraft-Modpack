...
// 执行功能的真配方
recipes.addHiddenShaped("soul_servant_bl_realrecipe", <lastsmith:.slashblade.named>, [
...
// 用来看的假配方
recipes.addShaped("soul_servant_bl", <lastsmith:.slashblade.named>.withTag({ModelName: "custom/soulservant/model", CurrentItemName: "custom_soulservant", TextureName: "custom/soulservant/texture", baseAttackModifier: 6.0 as float, CustomMaxDamage: 23}), [
    [<ore:bone>, <minecraft:rotten_flesh>, <lastsmith:blade>],
    [<minecraft:rotten_flesh>, proudsoul, <minecraft:rotten_flesh>],
    [<ore:stickWood>, <minecraft:rotten_flesh>, <ore:bone>]
], function(out,ins,info) {
